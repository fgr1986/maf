...
set style line 2 lc rgb '#5e9c36' lt 2 lw 2 pt 0 #green
set style line 3 lc rgb '#a2142f' lt 1 lw 2 pt 6 # red
set style line 4 lc rgb '#7e2f8e' lt 2 lw 2 pt 0# purple
...
# plot measuresFile   using 1:2 every ::1 axes x1y1 w lp ls 1  title 'Measures', \
#      simulationFile using 2:3 every ::1 axes x1y1 w lp ls 2  title 'Simulation', \
#      measuresFile   using 1:($1/$2) every ::1 axes x1y2 w lp ls 3  title 'Measures (Memristance)', \
#      simulationFile using 2:(1e3*$2/$3) every ::1 axes x1y2 w lp ls 4  title 'Simulation (Memristance)'
plot measuresFile   using 1:2 every ::1 axes x1y1 w lp ls 1  title 'Measures', \
     simulationFile using 2:3 every ::1 axes x1y1 w lp ls 2  title 'Simulation'

set output logOutputFile
set logscale y
plot measuresFile   using 1:(abs($2)) every ::1 w lp ls 1  title 'Measures', \
     simulationFile using 2:(abs($3)) every ::1 w lp ls 2  title 'Simulation'
